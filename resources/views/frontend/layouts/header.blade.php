...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{ route('home.index') }}">Liquor <span>store</span></a>
        <div class="order-lg-last btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item text-center btn-link d-block w-100" href="{{ route('home.cart') }}">
                    View All
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="{{ route('home.product') }}">Products</a>
                        <a class="dropdown-item" href="{{ route('home.detail') }}">Single Product</a>
                        <a class="dropdown-item" href="{{ route('home.cart') }}">Cart</a>
                        <a class="dropdown-item" href="{{ route('home.checkout') }}">Checkout</a>
                    </div>
                </li>
                <li class="nav-item"><a href="{{ route('home.news') }}" class="nav-link">Blog</a></li>
