...
Route::get('/thanh-toan', 'HomeController@checkout')->name('home.checkout');
Route::get('/chi-tiet-san-pham', 'HomeController@detail')->name('home.detail');
Route::get('/tin-tuc/{slug}', 'HomeController@newsList')->name('home.newsList');
Route::get('/chi-tiet-tin-tuc', 'HomeController@Blog')->name('home.detailBlog');
